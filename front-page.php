...
<style>
    ...
    .hero-section {
        ...
        /* Precise height minus header + border */
        display: flex;
        align-items: center;
        overflow: hidden;
        /* Added back to prevent horizontal scroll from image transform */
        background: radial-gradient(circle at 0% 0%, #0ea5e9 0%, #0b1120 55%, #020617 100%);
        color: #ffffff;
        width: 100%;
        max-width: 100%;
        /* Changed from 100vw to 100% to avoid scrollbar width issues */
        margin: 0;
        padding: 0;
    }
    ...
    .hero-overlay {
        position: absolute;
        inset: 0;
        background: radial-gradient(circle at 30% 50%, rgba(15, 23, 42, 0.3) 0%, rgba(15, 23, 42, 0.8) 50%, rgba(15, 23, 42, 1) 100%);
        z-index: 1;
    }
    ...
    .hero-img {
        ...
        filter: drop-shadow(0 0 100px rgba(2, 102, 158, 0.3));
        pointer-events: none;
    }
    ...
    .hero-btn {
        padding: clamp(12px, 1.5vw, 22px) clamp(32px, 4vw, 56px);
        border-radius: 12px;
        font-weight: 800;
        text-transform: uppercase;
    ...
    .hero-btn:hover {
        ...
        box-shadow: 0 30px 60px rgba(2, 102, 158, 0.4);
    }
    ...
    .hero-btn-primary {
        ...
        align-items: center;
        gap: 15px;
        padding: clamp(12px, 1.5vw, 18px) clamp(32px, 3vw, 45px);
        border-radius: 50px;
    }
    ...
    .bg-radial-gradient {
        background: radial-gradient(circle at center, rgba(2, 102, 158, 0.15) 0%, transparent 70%);
    }
    ...
    @media (max-width: 1024px) {
        ...
        .hero-overlay {
            background: radial-gradient(circle at 50% 50%, rgba(15, 23, 42, 0.7) 0%, rgba(15, 23, 42, 1) 100%);
        }
...
<section class="hero-section">
    ...
    <div id="age-verification-modal"
        class="fixed inset-0 z-[1100] hidden items-center justify-center p-4 bg-background/95 backdrop-blur-lg animate-fade-in">
        <div
            class="relative bg-white w-full max-w-lg rounded-[40px] p-12 text-center shadow-2xl border border-border overflow-hidden">
            <div class="relative space-y-10">
                <div class="flex justify-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/main logo  - Edited.png" alt="Logo"
                        class="h-16 w-auto">
                </div>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <button onclick="verifyAge(true)"
                        class="group relative bg-primary hover:bg-brand-blue-dark transition-all duration-500 rounded-2xl py-5 px-8 border border-primary overflow-hidden shadow-xl shadow-primary/20">
                        <span class="relative z-10 block font-display font-bold text-xl text-white">I AM 21+</span>
                    </button>

                    <button onclick="verifyAge(false)"
                        class="group relative bg-secondary hover:bg-secondary-foreground/10 transition-all duration-500 rounded-2xl py-5 px-8 border border-border overflow-hidden">
                ...
                <p class="text-[10px] uppercase tracking-widest text-muted-foreground/60 italic">
                    [All research must be conducted by qualified individuals. By entering, you agree to our Terms of
                    Service.]
                </p>
            </div>
        </div>
    ...
    <div id="first-visit-popup"
        class="fixed inset-0 z-[1000] hidden items-center justify-center p-4 bg-background/80 backdrop-blur-md animate-fade-in">
        <div
            class="relative bg-primary w-full max-w-lg rounded-[40px] p-12 text-center text-white shadow-2xl overflow-hidden group">
            <!-- Close Button -->
            ...
            <div class="absolute -top-24 -right-24 w-64 h-64 bg-white/5 rounded-full blur-3xl pointer-events-none">
            </div>
            ...
            <div class="relative space-y-8">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-white/80 text-lg">
                        Join the Colton Research community to receive <span class="text-white font-bold">5% off</span>
                        your first order.
                    </p>
                </div>
                ...
                <form id="popup-newsletter-form" class="space-y-4">
                    <input type="email" placeholder="Enter Email Address Here"
                        ...
                        required />
                    <button type="submit"
                        class="w-full bg-white text-primary font-bold py-5 rounded-2xl uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl">
                        Sign Up & Get 5% Off
                    </button>
                </form>
    ...
    <img src="<?php echo get_template_directory_uri(); ?>/assets/BPC-157.png" alt="BPC-157 research peptide vial"
        class="hero-img" />
    ...
    <div class="hero-container">
        <div class="hero-review-slider animate-fade-in">
            ...
            <div class="review-content-wrapper">
                <div class="review-item active">
                    <p class="review-text">"I absolutely love this company. Real legitimate products, easy to access
                        calculator guides, and fast shipping..."</p>
                </div>
                <div class="review-item">
                    <p class="review-text">"The purity levels are unmatched. Every batch I've tested has exceeded my
                        expectations for research consistency."</p>
                </div>
                <div class="review-item">
                    <p class="review-text">"Excellent customer support and detailed CoA documentation. Makes my
                        laboratory workflow much smoother."</p>
                </div>
            </div>
        </div>
        ...
        <div class="hero-content animate-slide-up">
            ...
            <p class="hero-desc">
                Research-only peptides with ≥99% purity, HPLC tested and batch-verified so your data is clean,
                repeatable, and publication-ready.
            </p>
            <div class="hero-btns">
...
<section class="trust-features-section reveal-on-scroll">
    <div class="trust-grid">
        <div
            class="trust-item group p-4 rounded-2xl transition-all duration-300 hover:bg-secondary/30 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1 cursor-default">
            <div
                class="trust-icon-box transition-transform duration-300 group-hover:scale-110 group-hover:bg-primary group-hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="space-y-8 text-left">
                <div class="space-y-4">
                    ...
                    <p class="text-lg text-muted-foreground leading-relaxed max-w-lg">
                        Experience a breakthrough in research with our advanced peptide formulations. Crafted for
                        scientists who demand the extraordinary.
                    </p>
                </div>
            ...
            <div class="relative">
                <div class="rounded-[40px] overflow-hidden">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/BPC-157.png" alt="Research Peptides"
    ...
    <div class="container mx-auto py-20 px-4">
        <div class="flex items-end justify-between mb-12">
            ...
            <a href="<?php echo esc_url(home_url('/shop')); ?>"
                class="hidden md:flex items-center gap-1 text-sm text-[#02669e] hover:underline font-medium transition-colors">
                View All <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="h-4 w-4">
...
<section class="py-24 bg-[#fafafa]">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
            <div class="text-left">
                ...
                <p class="text-muted-foreground leading-relaxed mt-6">
                    All products are supported by third-party laboratory testing and documented Certificates of
                    Analysis. These reports confirm compound identity and purity, giving you direct access to the same
                    data we use for internal quality verification.
                </p>
            </div>
            <div class="text-center lg:text-right">
                <div class="inline-block p-1 rounded-2xl bg-gradient-to-br from-primary/20 to-transparent">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/BPC-157.png"
                        alt="Peptide Vial with COA" class="rounded-xl shadow-xl max-w-md w-full mx-auto" />
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-wrap gap-4 mb-12" id="coa-tabs">
            <button
                class="coa-tab-btn active px-8 py-3 rounded-full bg-primary text-white font-bold text-sm uppercase transition-all duration-300"
                data-product="semaglutide">Semaglutide</button>
            <button
                class="coa-tab-btn px-8 py-3 rounded-full border border-primary text-primary font-bold text-sm uppercase transition-all duration-300 hover:bg-primary/5"
                data-product="bpc157">BPC-157</button>
            <button
                class="coa-tab-btn px-8 py-3 rounded-full border border-primary text-primary font-bold text-sm uppercase transition-all duration-300 hover:bg-primary/5"
                data-product="ipamorelin">Ipamorelin</button>
        </div>
...
<section class="bg-[#020617] text-white overflow-hidden">
    <div class="grid grid-cols-1 lg:grid-cols-2 items-center">
        <div class="relative h-[600px] lg:h-[800px] flex items-center justify-center bg-radial-gradient">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/BPC-157.png" alt="Research Peptides"
                class="w-full h-auto max-w-lg drop-shadow-[0_0_50px_rgba(2,102,158,0.5)]" />
        </div>
...
<section class="py-24 bg-white border-t border-border reveal-on-scroll">
    <div class="container mx-auto px-4 max-w-4xl">
        ...
        <div class="space-y-4">
            ...
            ?>
                <div
                    class="border border-border rounded-xl overflow-hidden faq-item transition-all duration-300 hover:border-primary/30">
                    <button
                        class="w-full flex items-center justify-between p-6 text-left hover:bg-secondary/30 transition-all duration-300 faq-toggle">
                        <span
                            class="font-display font-semibold text-foreground text-base pr-4"><?php echo $faq['q']; ?></span>
                        <div
                            class="h-8 w-8 rounded-full bg-secondary flex items-center justify-center shrink-0 transition-all duration-300 faq-icon-wrapper">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
                                class="h-4 w-4 text-primary transition-transform faq-icon">
                                <path d="m6 9 6 6 6-6" />
                            </svg>
                        </div>
                    </button>
...
<section class="py-24 bg-[#f8fafc] border-t border-border reveal-on-scroll">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Resource 1: 7 Steps -->
            <article
                class="group bg-white rounded-[32px] overflow-hidden border border-border transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 cursor-pointer"
                onclick="openResourceModal('reconstitution-guide')">
                <div
                    class="aspect-[4/3] bg-primary/5 flex items-center justify-center p-12 transition-colors duration-500 group-hover:bg-primary/10">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/BPC-157.png" alt="Reconstitution Guide"
                        class="w-full h-full object-contain drop-shadow-2xl transition-transform duration-700 group-hover:scale-110" />
                </div>
                <div class="p-8 space-y-4">
                    <h3
                        class="text-xl font-display font-bold text-foreground group-hover:text-primary transition-colors">
                        7 Steps to Reconstitute Peptides</h3>
                    <span class="text-xs font-medium text-muted-foreground uppercase tracking-widest block">January 13,
                        2026</span>
                    <p class="text-sm text-muted-foreground leading-relaxed line-clamp-3">
                        A guide on peptides, their benefits, and step-by-step directions for reconstituting lyophilized
                        (freeze-dried) peptides and instructions...
                    </p>
                </div>
            </article>
            ...
            <article
                class="group bg-white rounded-[32px] overflow-hidden border border-border transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 cursor-pointer"
                onclick="openResourceModal('peptide-calculator')">
                <div
                    class="aspect-[4/3] bg-primary/5 flex items-center justify-center p-12 transition-colors duration-500 group-hover:bg-primary/10">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/BPC-157.png" alt="Peptide Calculator"
                        class="w-full h-full object-contain drop-shadow-2xl transition-transform duration-700 group-hover:scale-110" />
                </div>
                <div class="p-8 space-y-4">
                    <h3
                    ...
                    <span class="text-xs font-medium text-muted-foreground uppercase tracking-widest block">January 15,
                        2026</span>
                    <p class="text-sm text-muted-foreground leading-relaxed line-clamp-3">
                        Use our Peptide Reconstitution Calculator below. Simply select your parameters to accurately
                        calculate dosages...
                    </p>
                </div>
            </article>
            ...
            <article
                class="group bg-white rounded-[32px] overflow-hidden border border-border transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 cursor-pointer"
                onclick="openResourceModal('bac-water-guide')">
                <div
                    class="aspect-[4/3] bg-primary/5 flex items-center justify-center p-12 transition-colors duration-500 group-hover:bg-primary/10">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/BPC-157.png" alt="BAC Water Guide"
                        class="w-full h-full object-contain drop-shadow-2xl transition-transform duration-700 group-hover:scale-110" />
                </div>
                <div class="p-8 space-y-4">
                    <h3
                        class="text-xl font-display font-bold text-foreground group-hover:text-primary transition-colors">
                        How Much Bacteriostatic Water to Add to Peptides?</h3>
                    <span class="text-xs font-medium text-muted-foreground uppercase tracking-widest block">January 2,
                        2026</span>
                    <p class="text-sm text-muted-foreground leading-relaxed line-clamp-3">
                        As peptides continue to grow in popularity each year, one of the most common questions people
                        ask is: How much bacteriostatic...
                    </p>
                </div>
            </article>
        </div>
...
<section class="border-t border-border bg-card">
    <div class="container mx-auto py-16 px-4 text-center">
        ...
        <form class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" id="newsletter-form">
            ...
            <button type="submit"
                class="bg-primary text-primary-foreground hover:bg-gold-light px-8 py-3 rounded-md font-semibold transition-colors">Subscribe</button>
            ...
            toggle.addEventListener('click', () => {
                ...
                faqItems.forEach(otherItem => {
                    if (otherItem !== item) {
                        ...
                        otherItem.querySelector('.faq-icon-wrapper').classList.remove(
                            'bg-primary');
...
<div id="modal-reconstitution-guide"
    class="fixed inset-0 z-[1000] hidden items-center justify-center p-4 bg-background/80 backdrop-blur-sm animate-fade-in">
    <div class="bg-card w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-[32px] border border-border shadow-2xl">
        <div class="sticky top-0 bg-card p-6 border-b border-border flex items-center justify-between">
            ...
            <button onclick="closeResourceModal('reconstitution-guide')"
        ...
        <div class="p-8 space-y-8">
            <div class="space-y-6">
                <div class="flex gap-4">
                    <div
                        class="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center font-bold shrink-0">
                        1</div>
                    <p class="text-muted-foreground"><strong class="text-foreground">Sanitize Everything:</strong> Wipe
                        the vial tops and your workspace with 70% isopropyl alcohol.</p>
                </div>
                <div class="flex gap-4">
                    <div
                        class="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center font-bold shrink-0">
                        2</div>
                    <p class="text-muted-foreground"><strong class="text-foreground">Draw Solvent:</strong> Using a
                        sterile syringe, draw the required amount of Bacteriostatic Water.</p>
                </div>
                <div class="flex gap-4">
                    <div
                        class="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center font-bold shrink-0">
                        3</div>
                    <p class="text-muted-foreground"><strong class="text-foreground">Inject Slowly:</strong> Direct the
                        needle at the side wall of the vial, not the powder directly.</p>
                </div>
                <div class="flex gap-4">
                    <div
                        class="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center font-bold shrink-0">
                        4</div>
                    <p class="text-muted-foreground"><strong class="text-foreground">Release Pressure:</strong> Allow
                        the air pressure to equalize before removing the needle.</p>
                </div>
                <div class="flex gap-4">
                    <div
                        class="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center font-bold shrink-0">
                        5</div>
                    <p class="text-muted-foreground"><strong class="text-foreground">Mix Gently:</strong> Swirl or roll
                        the vial between your palms. Do NOT shake.</p>
                </div>
                <div class="flex gap-4">
                    <div
                        class="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center font-bold shrink-0">
                        6</div>
                    <p class="text-muted-foreground"><strong class="text-foreground">Inspect:</strong> Ensure the
                        solution is clear and transparent with no particles.</p>
                </div>
                <div class="flex gap-4">
                    <div
                        class="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center font-bold shrink-0">
                        7</div>
                    <p class="text-muted-foreground"><strong class="text-foreground">Store Properly:</strong> Place in a
                        refrigerator at 2-8°C for stability.</p>
                </div>
            </div>
            <div class="bg-primary/5 p-6 rounded-2xl border border-primary/10">
                <p class="text-xs text-primary leading-relaxed">
                    <strong class="uppercase font-bold block mb-1">Important:</strong> Lyophilized peptides are
                    extremely sensitive. Shaking or exposing them to heat can degrade the compound identity and purity.
                </p>
            </div>
        </div>
    </div>
...
<div id="modal-peptide-calculator"
    class="fixed inset-0 z-[1000] hidden items-center justify-center p-4 bg-background/80 backdrop-blur-sm animate-fade-in">
    <div class="bg-card w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-[32px] border border-border shadow-2xl">
        <div class="sticky top-0 bg-card p-6 border-b border-border flex items-center justify-between">
            <h2 class="text-2xl font-display font-bold text-foreground">Peptide Calculator</h2>
            <button onclick="closeResourceModal('peptide-calculator')"
                class="p-2 hover:bg-secondary rounded-full transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <line x1="18" y1="6" x2="6" y2="18" />
        ...
        <div class="p-8">
            <form id="peptide-calc-form" class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-xs font-bold uppercase tracking-wider text-muted-foreground">Peptide Strength
                            (mg)</label>
                        <input type="number" id="calc-mg" value="5"
                            class="w-full bg-secondary border border-border rounded-xl p-4 text-foreground focus:outline-none focus:ring-2 focus:ring-primary" />
                    </div>
                    <div class="space-y-2">
                        <label class="text-xs font-bold uppercase tracking-wider text-muted-foreground">BAC Water Volume
                            (mL)</label>
                        <input type="number" id="calc-water" value="3"
                            class="w-full bg-secondary border border-border rounded-xl p-4 text-foreground focus:outline-none focus:ring-2 focus:ring-primary" />
                    </div>
                    <div class="space-y-2 md:col-span-2">
                        <label class="text-xs font-bold uppercase tracking-wider text-muted-foreground">Desired Dose
                            (mcg)</label>
                        <input type="number" id="calc-dose" value="250"
                            class="w-full bg-secondary border border-border rounded-xl p-4 text-foreground focus:outline-none focus:ring-2 focus:ring-primary" />
                    </div>
                </div>
                ...
                <div class="bg-primary p-8 rounded-[24px] text-white space-y-6 mt-8">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        <div>
                            <span
                                class="text-[10px] uppercase tracking-[0.2em] font-bold opacity-70">Concentration</span>
                            <div id="calc-res-concentration" class="text-2xl font-display font-bold">1.67 mg/mL</div>
                        </div>
                        <div>
                            <span class="text-[10px] uppercase tracking-[0.2em] font-bold opacity-70">Draw Syringe
                                To</span>
        ...
        <div class="p-8 space-y-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="p-6 bg-secondary/50 rounded-2xl border border-border">
                    ...
                    <p class="text-sm text-muted-foreground">Use 1 mL or less. Ideal for GLP-1 peptides to maintain high
                        concentration.</p>
                </div>
                <div class="p-6 bg-secondary/50 rounded-2xl border border-border">
                    <h3 class="font-bold text-primary mb-2">Multi-Dose Use</h3>
                    <p class="text-sm text-muted-foreground">Use 2–3 mL. Makes measuring small doses (like BPC-157)
            ...
            <div class="space-y-4">
                ...
                <p class="text-sm text-muted-foreground leading-relaxed">
                    Unlike sterile water, BAC water contains 0.9% benzyl alcohol, which prevents bacterial growth for up
                    to 30 days after opening. This is essential for multi-dose vials to ensure research integrity and
                    subject safety.
                </p>
            </div>
        </div>
